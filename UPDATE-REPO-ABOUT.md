...
gh repo edit <owner>/<repo> \
  --description "E-INFRA S.A. group scraper — 6 companies (Electrogrup, Direct One, Netcity, Nova Power & Gas, WESEE)"
...
# Topics
gh repo edit <owner>/<repo> \
  --add-topic job-seeker-ro-spider --add-topic peviitor-ro --add-topic e-infra
```
